  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta name="description" content="Danh mục đầy đủ các loại xe tải, xe cẩu, sơ mi rơ mooc và xe đầu kéo với đa dạng thương hiệu và tải trọng. Tìm kiếm và so sánh xe phù hợp với nhu cầu của bạn." />
      </Helmet>
