...
const TruckDetail = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>{truck.name} | chuyendungvn.com</title>
    ...
    <tr className="border-b">
      ...
      <td className="py-2 font-medium">{truck.trailerSpec?.tireSpec || truck.tires || '-'}</td>
                        ...
                        <tr className="border-b">
                          ...
                          <td className="py-2 font-medium">{truck.trailerSpec?.wheelbase || '4.520 + 1.310 + 1.310 mm'}</td>
                        </tr>
                        <tr className="border-b">
                          <td className="py-2 text-gray-600">Khối lượng bản thân</td>
                          <td className="py-2 font-medium">{truck.trailerSpec?.specialFeatures?.[2]?.split(': ')[1] || '8.420 kg'}</td>
                        </tr>
                        <tr className="border-b">
                          <td className="py-2 text-gray-600">Khối lượng chở cho phép</td>
                          <td className="py-2 font-medium">{truck.trailerSpec?.specialFeatures?.[3]?.split(': ')[1] || '28.490 kg'}</td>
                        </tr>
                        <tr className="border-b">
                          <td className="py-2 text-gray-600">Khối lượng toàn bộ</td>
                          <td className="py-2 font-medium">{truck.trailerSpec?.specialFeatures?.[4]?.split(': ')[1] || '36.910 kg'}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="w-full border-collapse">
                      <tbody>
                        ...
                        <tr className="border-b">
                          ...
                          <td className="py-2 font-medium">{truck.trailerSpec?.specialFeatures?.[6]?.split(': ')[1] || 'Thép ATOS80'}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="w-full border-collapse">
                      <tbody>
                        <tr className="border-b">
                          ...
                          <td className="py-2 font-medium">{truck.trailerSpec?.specialFeatures?.[0]?.split(': ')[1] || '25,6 m³'}</td>
                        </tr>
                        <tr className="border-b">
                    ...
                    <table className="w-full border-collapse">
                      <tbody>
                        <tr className="border-b">
                          ...
                          <td className="py-2 font-medium">{truck.trailerSpec?.containerLock || '2" hoặc 3.5", liên kết bulong'}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    <table className="w-full border-collapse">
                      <tbody>
                        <tr className="border-b">
                          ...
                          <td className="py-2 font-medium">{truck.trailerSpec?.specialFeatures?.[9]?.split(': ')[1] || 'Kiểu tang trống, dẫn động bằng khí nén 2 dòng'}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  ...
                  {/* Hệ thống xy lanh nâng hạ thùng hàng */}
                  <div>
                    ...
                    <table className="w-full border-collapse">
                      <tbody>
                        <tr className="border-b">
                          ...
                          <td className="py-2 font-medium">{truck.trailerSpec?.specialFeatures?.[11]?.split(': ')[1] || 'Tháp ben HYVA FC A202-5 cao cấp mạ crom'}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
