...
const AboutPage = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Giới Thiệu | ChuyenDungVN.com - Chuyên Phương Tiện Thương Mại | Xe Tải, Cẩu, Mooc & Đầu Kéo</title>
        <meta name="description" content="Tìm hiểu về ChuyenDungVN - Nhà phân phối xe tải, xe đầu kéo, xe cẩu và mooc hàng đầu Việt Nam với hơn 10 năm kinh nghiệm." />
      </Helmet>
