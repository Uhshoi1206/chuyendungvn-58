...
const BlogPostPage = () => {
  ...
  if (!post) {
    return (
      <Layout>
        <Helmet>
          <title>Bài viết không tồn tại | chuyendungvn.com</title>
        </Helmet>
  ...
  const generateStructuredData = () => {
    const structuredData = {
      ...
      "publisher": {
        "@type": "Organization",
        "name": "chuyendungvn.com",
        "logo": {
          "@type": "ImageObject",
          "url": "https://chuyendungvn.com/favicon.ico"
        }
      },
  ...
  return (
    <Layout>
      <Helmet>
        <title>{post.title} | chuyendungvn.com</title>
        <meta name="description" content={post.description || post.title} />
        <meta name="keywords" content={post.tags?.join(', ') || ''} />
        <meta property="og:title" content={`${post.title} | chuyendungvn.com`} />
        ...
        <meta name="twitter:title" content={`${post.title} | chuyendungvn.com`} />
        <meta name="twitter:description" content={post.description || post.title} />
        <meta name="twitter:image" content={post.images[0]} />
        <link rel="canonical" href={`https://chuyendungvn.com${getPostUrl(post)}`} />
